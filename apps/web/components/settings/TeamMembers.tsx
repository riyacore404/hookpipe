...
export default function TeamMembers({ orgId }: { orgId: string }) {
    ...
    <div className="max-w-2xl">
      ...
      {showForm && (
        <div className="mb-4 p-4 bg-white border border-gray-200 rounded-xl">
          <p className="text-xs font-medium text-gray-700 mb-3">Invite by Clerk user ID</p>
      ...
      <div className="bg-white border border-gray-100 rounded-xl overflow-hidden">
        {!members || members.length === 0 ? (
          <div className="px-4 py-8 text-center text-sm text-gray-400">No members yet</div>
        ) : (
          members.map((member, i) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs font-mono text-gray-600 truncate">{member.userId}</p>
